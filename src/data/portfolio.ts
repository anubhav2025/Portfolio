...
export const experience: Experience[] = [
  {
    ...
    description: [
      ...
      "Integrated and enhanced major security tool pipelines (Axonius, Cortex XDR, GitGuardian, Cobalt, Polyspace), improving scan ingestion, tagging, and classification reliability.",
